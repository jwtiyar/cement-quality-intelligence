...
- **Machine Learning Strength Prediction:** Automatically trains XGBoost models on your historical data (spanning 10+ years) to predict 28-day compressive strength based on 2-day strength, chemistry, and fineness. Separate models are trained dynamically for OPC, SRC, and SBC. Validation is chronological (train on oldest 80%, validate on newest 20%) so reported R² and RMSE are honest forward-prediction numbers.
